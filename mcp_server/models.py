...
#   timestamp: 2025-06-28T15:08:39+00:00
...
class CertificateParameters(BaseModel):
    ...
    rollcode: str = Field(..., description='Roll Code', examples=['11001'])
    rollno: str = Field(..., description='Roll No', examples=['X00X'])
    year: str = Field(
        ...,
        description='Year',
        examples=['2009,2010,2011,2012,2013,2014,2015,2016,2017'],
    )
